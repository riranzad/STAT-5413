...
$$
\begin{align}
\mathbf{y}_{unobs} | \mathbf{y}_{obs} & \sim \operatorname{N} \left( \boldsymbol{\Sigma}_{unobs,obs} \boldsymbol{\Sigma}_{obs}^{-1} \mathbf{y}_{obs}, \boldsymbol{\Sigma}_{unobs,obs} \boldsymbol{\Sigma}_{obs}^{-1} \boldsymbol{\Sigma}_{obs,unobs} \right)
\end{align}
$$
...
## Kriging variance
pred_var      <- diag(Cov_unobs) - diag(Cov_unobs_obs %*% Cov_inv %*% t(Cov_unobs_obs))
